...
export const metadata: Metadata = {
  ...
  description: 'Behind-the-scenes stories, process notes, and dispatches from the atelier of NTK Trinh Chau.',
      ...
      <main className="pt-6 pb-16 px-6 max-w-2xl mx-auto">
        ...
        {posts.length > 0 ? (
          ...
          <div className="py-24 text-center text-on-surface-variant">
            <p className="font-mono text-[0.6875rem] uppercase tracking-label">No dispatches have yet been published</p>
          </div>
        )}
      </main>
