  ...
  return (
    <div className="min-h-screen bg-background pb-24 md:pb-0">
      ...
      <main className="pt-6 pb-16 px-6 max-w-2xl mx-auto">
        ...
        {/* Featured image */}
        {post.featured_image && (
          <div className="w-full mb-10 bg-surface-container-high overflow-hidden">
            <Image
        ...
        <section className="mb-12">
          ...
          <h1
            className="text-[2rem] leading-[1.1] font-light text-on-surface mb-4"
        ...
        {post.content && (
          <article
            className="prose prose-sm max-w-none font-light text-on-surface leading-relaxed space-y-4"
            style={{ letterSpacing: '-0.14px' }}
          >
            {post.content.split('\n\n').map((paragraph, i) =>
              paragraph.trim() ? (
